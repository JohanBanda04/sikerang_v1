              ...
              <tr>
                ...
                if (mysqli_num_rows($query)) {
                  while($row=mysqli_fetch_assoc($query)):
                   ...
                   <td>
                       <a target="_blank" href="cetakpengajuan.php?&tgl=<?= $row['tgl_pengajuan']; ?>&unit=<?= $row['unit']; ?>"><span data-placement='top' data-toggle='tooltip' title='Cetak'><button class="btn btn-success">
