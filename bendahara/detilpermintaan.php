...
if (isset($_GET['tgl']) && isset($_GET['unit'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT permintaan.tgl_permintaan, permintaan.id_permintaan, 
                        ...
                        <table class="table text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a  href="setuju.php?id=<?= $row['id_permintaan']; ?>&unit=<?= $unit; ?>&tgl=<?= $tgl; ?>">
                                        <span data-placement='top' data-toggle='tooltip' title='Setujui'>
                                            <button class="btn btn-success">Setujui</button>
                                        </span>
                                    </a>

                                    <a  href="tidaksetuju.php?tgl=<?= $tgl; ?>&unit=<?= $unit; ?>&id=<?=$row['id_permintaan']; ?>">
                                        <span data-placement='top' data-toggle='tooltip' title='Tidak Setuju'>
                                            <button class="btn btn-danger" >Tidak Setuju</button>
                                        </span>
                                    </a>

                                    <a  href="?p=editpesanminta&id=<?=$row['id_permintaan']; ?>">
