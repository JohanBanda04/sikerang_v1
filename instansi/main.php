	...
	<div id="myModal" class="modal fade" role="dialog">
		...
		<div class="modal-dialog">
            <div class="input-group hidden">
                <span class="input-group-addon"><i class="fa fa-comment" style="color: #0f74a8"></i></span>
                <input  type="text" class="form-control" placeholder="Memo" name="Memo"  required>
            </div>
			<!-- konten modal-->
			<div class="modal-content">
				...
				<div class="modal-body">
			         <p>1. Unit/Intalasi menginput data permintaan barang di form permintaan barang.</p>
            <p>2. Permintaan unit/instalasi di konfirmasi oleh Bendahara.</p>
            <p>3. Setelah di konfirmasi, kemudian Unit/Instalasi mencetak Bukti Permintaan Barang dan kemudian membawa Bukti yang telah di sah kan oleh Kepala Unit/Intalasi dan diserahkan ke Unit Pengelola Aset (Bagian Keuangan) untuk dilakukan proses pengeluaran barang.</p>
				</div>
				<!-- footer modal -->
